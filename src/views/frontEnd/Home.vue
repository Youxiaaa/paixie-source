    ...
    <div>
      ...
      <section>
        <div class="banner d-flex align-items-center">
          ...
          <div class="phonesizeBannerTitle">
            <h2 class="h1 text-primary">拍謝</h2>
            <h3 class="h1 text-white">對於影像設備</h3>
            <h3 class="h1 text-white">我們從不馬虎</h3>
          </div>
      ...
      <section>
          ...
          <div class="container">
              ...
              <div class="row d-flex flex-row-reverse my-5 preFadein">
                ...
                <div class="col-md-6">
                  <img src="@/img/lens.jpg" alt="照相機 鏡頭" title="圖片源自 Unsplash">
                </div>
              </div>
              ...
              <div class="row preFadein">
                ...
                <div class="col-md-6">
                  <img src="@/img/light.jpeg" alt="照相機 腳架" title="圖片源自 Unsplash">
                </div>
              </div>
      ...
      <section>
        ...
        <button type="button" class="btn btn-primary btn-lg text-white mt-5 p-3" @click.prevent="toProducts('')">前 往 商 品 頁</button>
          ...
          <div class="row preFadein">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center">
              ...
              <div class="phoneAreaText">
                ...
                <p class="h4 text-secondary py-3">
                  <span>現在訂閱 馬上享9折優惠</span>
                  <br>
                  <br>
                  <span>我們會於每月10號寄送95折優惠券</span>
                </p>
              </div>
              </div>
            </div>
              ...
              <div class="phoneCase preShake">
                <div class="phoneScreen">
                  <div class="phonePage1 preFadeinRight">
                    ...
                    <br>
                    <h3 class="h4 text-secondary mt-4 mb-5">請輸入您的電子信箱</h3>
                    ...
                    <button type="submit" class="btn btn-primary text-white mt-4 px-3 py-2 ml-auto" :disabled="invalid">送出</button>
                    </form>
                    </validation-observer>
                    </div>
                  </div>
                  <div class="phonePage2">
                    <div class="text-center">
                    <img src="@/img/thank-you.svg" alt="thank you">
                    </div>
