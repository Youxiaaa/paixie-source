        ...
        <section>
            <div class="signinArea">
                ...
                <div class="signinCard">
                    ...
                    <h2 class="text-center h2 mb-4 text-primary">S i g n I n</h2>
                    ...
                    <br>
                    <a href="#" @click.prevent="forGetpw">忘記密碼？</a>
                    <br>
                ...
                <div class="signupCard">
                    ...
                    <h2 class="h2 text-primary mb-4 text-center">S i g n U p</h2>
...
export default {
  ...
  methods: {
    ...
    sendSignup () {
      const self = this
      alert(`我們已將確認信寄送至您填寫的“${self.signupData.email}”信箱囉 請再點擊確認郵件後以完成註冊`)
    },
    forGetpw () {
      alert('本網站不允許忘記密碼唷 盒盒盒盒盒盒')
    }
  },
  created () {
    this.openPage()
