<template>
    <div>
        ...
        <h2 class="text-primary checkOutTitle mt-5">S T E P 1 . 填 寫 訂 單</h2>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-7 px-5 bg-light mt-3">
                ...
                <validation-observer v-slot="{ invalid }">
                  ...
                  <input id="address" type="address" name="收件人地址" v-model="checkoutData.user.address" class="form-control" :class="classes">
                  <span class="invalid-feedback"> {{ errors[0] }} </span>
                  </div>
                  </validation-provider>
